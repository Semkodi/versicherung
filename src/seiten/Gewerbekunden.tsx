...
const Gewerbekunden = () => {
    const leistungen = [
        { icon: Building2, titel: "Betriebshaftpflicht", text: "Umfassender Schutz für Personen-, Sach- und Vermögensschäden." },
        { icon: ShieldAlert, titel: "Inhaltsversicherung", text: "Sicherheit für dein Betriebsinventar, Vorräte und Elektronik." },
        { icon: Truck, titel: "Flottenversicherung", text: "Maßgeschneiderte Lösungen für deinen Fuhrpark – vom PKW bis zum LKW." },
        { icon: Briefcase, titel: "Rechtsschutz", text: "Rechtssicherheit für dein Unternehmen und deine Mitarbeiter." }
    ];
            ...
            <div className="pt-40 pb-24 px-4 bg-hintergrund-alt relative">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center">
                        ...
                        >
                            Schutz für <br />
                            <span className="text-marke-primaer">Gewerbekunden</span>
                        </motion.h1>
                        <p className="text-xl text-text-neben max-w-2xl mx-auto leading-relaxed">
                            Dein Unternehmen verdient den besten Schutz. Wir unterstützen dich bei der Absicherung deiner betrieblichen Risiken.
                        </p>
                    </div>
                </div>
            </div>
