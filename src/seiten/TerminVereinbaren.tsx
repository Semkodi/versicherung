    ...
    return (
        <main className="relative z-10 overflow-hidden bg-hintergrund-alt text-[#020A39]">
            <UnterseitenHero
                ...
                titel="Dein Wunschtermin"
                hervorhebung="direkt mit Sven"
                beschreibung="Wähle den passenden Termin für deine persönliche Beratung. Online, telefonisch oder vor Ort: Wir nehmen uns Zeit für deine Fragen."
                punkte={[
                ...
                bild={kontaktHeroImg}
                bildAlt="Sven Kegler als persönlicher Versicherungsmakler"
                bildKlasse="unterseiten-hero__bild--kontakt"
                primaer={{ text: "Termin auswählen", href: "#terminformular" }}
            />
            
            {/* Formular & Kontakt-Info */}
            <section id="terminformular" className="py-16 bg-hintergrund-alt relative scroll-mt-24">
