                    ...
                    <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-10 max-w-3xl">
                                Wir sind für dich da bei der Suche nach der passenden Versicherungslösung, bei der Verwaltung deiner Unterlagen und natürlich auch im Schadensfall. Um einen Termin (Online-Meeting, persönliches Gespräch vor Ort in Elbtal, persönliches Gespräch bei dir zu Hause, Rückruf) zu vereinbaren, fülle bitte hierzu das angegebene Formular aus.
                            </p>
