...
const RueckrufAnfordern = () => {
    ...
    const absenden = (e: React.FormEvent) => {
        ...
        if (!vorname || !nachname || !email || !telefon || !datenschutzAkzeptiert || !hcaptchaChecked) return;

        const betreff = encodeURIComponent(`📞 Neuer Rückrufwunsch - ${vorname} ${nachname}`);
        const text = encodeURIComponent(
            `Hallo Sven,\n\nich möchte einen Rückruf anfordern.\n\n` +
            `📅 Bevorzugtes Datum für Rückruf: ${datum || 'Möglichst bald'}\n` +
            `⏰ Bevorzugtes Zeitfenster: ${uhrzeit || 'Möglichst bald'}\n\n` +
            `👤 Meine Kontaktdaten:\n` +
    ...
    return (
        <main className="relative z-10 overflow-hidden bg-hintergrund-alt text-[#020A39]">
            <UnterseitenHero
                ...
                hervorhebung="wenn es dir passt"
                beschreibung="Hinterlasse deinen Rückrufwunsch und Sven Kegler meldet sich persönlich zum gewünschten Zeitpunkt bei dir."
                punkte={[
                    "Wunschzeit einfach angeben",
                    "Persönlicher Rückruf von Sven",
                    "Kurze Wege ohne Warteschleife",
                ]}
                bild={kontaktHeroImg}
                bildAlt="Sven Kegler als persönlicher Ansprechpartner"
                bildKlasse="unterseiten-hero__bild--kontakt"
                primaer={{ text: "Rückruf anfordern", href: "#rueckrufformular" }}
            />
            
            {/* Formular & Kontakt-Info */}
            <section id="rueckrufformular" className="py-16 bg-hintergrund-alt relative scroll-mt-24">
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-10 max-w-3xl">
                                Wir sind für dich da bei der Suche nach der passenden Versicherungslösung, bei der Verwaltung deiner Unterlagen und natürlich auch im Schadensfall. Um einen telefonischen Rückruf zu vereinbaren, fülle bitte das angegebene Formular aus. Wir rufen dich zum Wunschtermin an.
                            </p>
                            ...
                            {!wurdeGesendet ? (
                                <form onSubmit={absenden} className="space-y-6">
                                    ...
                                    {/* Zwischenüberschrift: Rückrufwunsch */}
                                    <div className="pt-4 border-b border-gray-100 pb-2">
                                        <h3 className="font-bold text-lg text-[#020A39]">Rückrufwunsch</h3>
                                    </div>
                                ...
                                >
                                    ...
                                    <h3 className="font-extrabold text-3xl text-[#020A39] mb-4 tracking-tight">Rückrufwunsch vorbereitet!</h3>
                                    <p className="text-gray-600 text-base max-w-lg mb-8 leading-relaxed font-normal">
                                        Hallo <span className="font-bold text-[#020A39]">{vorname}</span>, deine E-Mail mit deinem Rückrufwunsch wurde erzeugt und in deinem E-Mail-Programm geöffnet.
                                    </p>
                                    <button
                                        type="button"
