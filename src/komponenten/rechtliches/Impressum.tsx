...
const Impressum = () => {
    usePageMetadata({
        title: "Impressum | simply switch Versicherungsmakler Sven Kegler",
        description: "Rechtliche Angaben und Pflichtinformationen nach § 5 DDG und § 15 VersVermV für simply switch Sven Kegler Versicherungsmakler in Elbtal."
    });
